...
public class Sudoku_code extends Frame {
    public int a=1;
    ...
    */
    ...
    Sudoku_code() {
        ...
        f2.setIconImage(new ImageIcon("sudoku.png").getImage());
        ...
        class ButtonClickedListener implements ActionListener {
            public void actionPerformed(ActionEvent e) {
                ...
                if (c.equals("PLAY")) {
                    ...
                    f3.setIconImage(new ImageIcon("sudoku.png").getImage());
                    Panel p14 = new Panel();
                    ...
                    Main.setIconImage(new ImageIcon("sudoku.png").getImage());
                    ...
                    class ButtonClickListener implements ActionListener {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            ...
                            if (command.equals("Give Up!")) {
                                ...
                                f1.setIconImage(new ImageIcon("sudoku_sad.png").getImage());
                    ...
                    class ButtonClickedListener4 implements ActionListener {
                        public void actionPerformed(ActionEvent e) {
                            ...
                            if (get.equals("SUBMIT")) {
                                ...
                                Panel pf = new Panel();
                                ImageIcon image1 = new ImageIcon("Sudoku_smile.jpg");
        ...
        Panel p13 = new Panel();
        ImageIcon image = new ImageIcon("sudoku_home.png");
    ...
    public static void main(String[] args) {
        Sudoku_code obj = new Sudoku_code();
